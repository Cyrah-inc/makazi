      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground text-sm">Stay updated on payouts and activity.</p>
          </div>
          {unreadCount > 0 && (
          ...
          <CardContent className="p-0">
            {isLoading ? (
              ...
              <div className="text-center py-12">
                ...
                <p className="text-muted-foreground text-xs mt-1">You'll be notified when payouts are processed.</p>
              </div>
            ) : (
