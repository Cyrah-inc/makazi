...
const BuyPage = () => {
  ...
  const sections = (
    <>
      <PropertyCarousel
        title="Trending for Sale"
        subtitle="Most popular properties on the market"
      ...
      <PropertyCarousel
        ...
        subtitle="Houses, villas & bungalows"
      ...
      <PropertyCarousel
        ...
        subtitle="Business premises & commercial spaces"
        properties={commercial.data ?? []}
        isLoading={commercial.isLoading}
        seeAllLink="/buy?type=commercial"
      ...
      <PropertyCarousel
        ...
        seeAllLink="/buy?type=apartment"
        icon={<Building className="h-5 w-5 text-primary" />}
      />
      <PropertyCarousel
        title="Townhouses & Maisonettes"
        subtitle="Spacious multi-level living"
        properties={townhouses.data ?? []}
        isLoading={townhouses.isLoading}
        seeAllLink="/buy?type=townhouse"
